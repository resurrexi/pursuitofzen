  ...
  return (
    <>
      ...
      {loaded && resolvedTheme === "light" ? (
        <button
          type="button"
          className="group flex w-full place-content-center p-2 text-amber-600 focus:outline-none"
        ...
        <button
          type="button"
          className="group flex w-full place-content-center p-2 text-amber-500 focus:outline-none"
